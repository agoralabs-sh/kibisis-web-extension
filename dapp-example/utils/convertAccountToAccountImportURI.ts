...
export default function convertAccountToAccountImportURI(
  ...
  return `${ARC_0300_SCHEME}://${ARC0300AuthorityEnum.Account}/${ARC0300PathEnum.Import}?${ARC0300QueryEnum.Encoding}=${encoding}&${ARC0300QueryEnum.PrivateKey}=${encodedPrivateKey}`;
}
