 ...
 * * the amount of transactions in a group of atomic transactions does not exceed 16
...
export default function verifyTransactionGroups(
  ...
  return groupsOfTransactions
    .reduce<boolean[]>((acc, currentValue) => {
      ...
      // if the amount of atomic transactions should not exceed 16, as defined in ARC-0003
