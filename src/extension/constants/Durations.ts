...
export const PASSWORD_DURATION_LOWEST: number = 60000; // 1 minute in milliseconds
export const PASSWORD_DURATION_LOW: number = 120000; // 2 minutes in milliseconds
export const PASSWORD_DURATION_NORMAL: number = 300000; // 5 minutes in milliseconds
export const PASSWORD_DURATION_HIGH: number = 600000; // 10 minutes in milliseconds
export const PASSWORD_DURATION_HIGHER: number = 900000; // 15 minutes in milliseconds
export const PASSWORD_DURATION_HIGHEST: number = 1800000; // 30 minutes in milliseconds
